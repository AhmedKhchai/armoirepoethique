    ...
    <div class="container body-container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12">
                <h1 class="main-title">
                    Une boutique à Bordeaux dédiée à la mode éthique à partir de mars 2022 !
                </h1>
                <hr class="separator">
                <p class="main-text">
                    L’Armoire Poéthique proposera une boutique multi-marques en mars 2022, pour les femmes et les
                    hommes
                    de vêtements, chaussures et accessoires écologiques et durables couplé à un lieu de
                    sensibilisation
                    pédagogique sur les enjeux des filières du vêtement éthique.
                </p>
                <p class="main-text"> Avec l’Armoire Poéthique, vous pourrez être bien habillé en sachant pourquoi
                    !

                </p>
                <h3 class="sub-title">
                    Vous voulez en savoir plus sur l’Armoire Poéthique ? Inscrivez-vous à notre Newsletter !
                </h3>
                {{-- <form method="POST" action="/">
                    @csrf
                    <input type="email" class="email-input" placeholder="Entrer mon adresse mail…" name="email">
                ...
                @else
                    <form method="POST" action="/" class="input-form">
                        ...
                        <div class="container mt-3">
                            <div class="row">
                                <input type="email" class=" col-lg-7 email-input mb-2"
                                    placeholder="Entrer mon adresse mail…" name="email">
                                <button type="submit" class=" col-lg-4 email-submit-btn">
                                    Envoyer
